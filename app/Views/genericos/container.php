        ...
        <div class="col-12 col-lg-6 col-md-12 col-sm-12 centrado" id="about">
            <div class="mx-auto">
                <div class="container p-5 text-about">
                    <h3 class="text-about title">Sobre nosotros</h3>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active text-center" data-bs-interval='5000'>
                ...
                <div class="carousel-caption px-4 col-7 col-lg-5 col-md-5 col-sm-7">
                    <h3 class="text-white title">¡Registrate!</h3>
            ...
            <div class="carousel-item" data-bs-interval='3000'>
                ...
                <div class="carousel-caption px-4 col-7 col-lg-5 col-md-5 col-sm-7" sytle="bottom: 50px;">
                    <h2 class="text-white text-left col-8 mr-auto title">Misión</h2>
                    <p>
            ...
            <div class="carousel-item" data-bs-interval='5000'>
                ...
                <div class="carousel-caption px-4 col-7 col-lg-5 col-md-5 col-sm-7" sytle="bottom: 50px;">
                    <h2 class="text-white text-justify title">Visión</h2>
                    <p>
...
<div id="productos" class="container-fluid text-center">
  <h3 class="title" style="color: #9162DD">Nuestros productos</h3><br>
  ...
  <div class="container py-5">
    <div class="row d-flex justify-content-center">
      <div class="col-md-10 col-xl-8 text-center">
        <h3 style="color: #9162DD" class="fw-bold mb-4 title">Comentarios de nuestros clientes</h3>
      </div>
    </div>
...
<div id="contact" class="container-fluid text-center contact p-2">
  <h1 class="text-center cnt-txt title">CONTACTO</h1>
  <div class="row">
