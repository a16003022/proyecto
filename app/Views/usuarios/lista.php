                                            ...
                                            echo "<td>";
                                                ...
                                                echo "</div>";
                                                    ...
                                                    echo "<input type='hidden' name='precio' value='".$dat["precio"]."'>";
                                                        ...
                                                        endforeach;
                                                        if ($prodAñadido){ 
                                                        echo "<button type='submit' class='btn btn-primary btn-sm btn-jumbotron' disabled><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-bag' viewBox='0 0 16 16'>
